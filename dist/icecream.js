...
export function runIceCreamCalculator() {
    ...
    const size = sizeRaw;
    const toppingsRaw = ask("Вкажіть начинку через кому. Доступні: chocolate, caramel, berries. (min 1)")
        ?.split(",")
